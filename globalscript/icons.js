...
const playsvg = 
    ...
    viewBox="0 0 30.065 30.065" style="enable-background:new 0 0 512 512"
    xml:space="preserve" class="">
    <g>
        <path
            d="M26.511 12.004 6.233.463C4.082-.765 1.889.578 1.889 2.993v24.093c0 2.046 1.332 2.979 2.57 2.979.583 0 1.177-.184 1.767-.543l20.369-12.468c1.024-.629 1.599-1.56 1.581-2.555-.017-.996-.623-1.906-1.665-2.495zm-1.281 2.823L4.862 27.292a1.297 1.297 0 0 1-.319.147 1.354 1.354 0 0 1-.04-.353V2.994c0-.248.045-.373.045-.404.08.005.22.046.396.146l20.275 11.541c.25.143.324.267.348.24-.013.034-.098.161-.337.31z"
            style="" fill="#010002" data-original="#010002" class=""></path>
    </g>
    </svg>`
;
const pausesvg = 
    ...
    <g>
        <path
            d="M12 5a5 5 0 0 0-5 5v28a5 5 0 0 0 5 5h4a5 5 0 0 0 5-5V10a5 5 0 0 0-5-5zm7 5v28a3 3 0 0 1-3 3h-4a3 3 0 0 1-3-3V10a3 3 0 0 1 3-3h4a3 3 0 0 1 3 3zM32 43h4a5 5 0 0 0 5-5V10a5 5 0 0 0-5-5h-4a5 5 0 0 0-5 5v28a5 5 0 0 0 5 5zm-3-33a3 3 0 0 1 3-3h4a3 3 0 0 1 3 3v28a3 3 0 0 1-3 3h-4a3 3 0 0 1-3-3z"
...
const unmutesvg = 
    ...
    <g>
        <g fill="#424242">
            <path d="m35 4v56l-5-4.41-4.08-3.6-7.92-6.99v-26l12-10.59z"
                fill="#424242" data-original="#424242" class=""></path>
            <path
                d="m6 19h12a0 0 0 0 1 0 0v26a0 0 0 0 1 0 0h-12a2 2 0 0 1 -2-2v-22a2 2 0 0 1 2-2z"
                fill="#424242" data-original="#424242" class=""></path>
            <path
                d="m39.67 22.79a.999.999 0 0 0 -1.47.2l-1.14 1.66a.9886.9886 0 0 0 .17 1.31 7.97 7.97 0 0 1 0 12.08.9886.9886 0 0 0 -.17 1.31l.5.73.64.93a.999.999 0 0 0 1.47.2 11.96 11.96 0 0 0 0-18.42z"
                fill="#424242" data-original="#424242" class=""></path>
            <path
                d="m50.07 23.45a19.8971 19.8971 0 0 0 -5.91-7.32.977.977 0 0 0 -1.41.24l-1.15 1.66a.9933.9933 0 0 0 .23 1.35 16.121 16.121 0 0 1 5.5 8.04 15.7576 15.7576 0 0 1 .67 4.58 16.0112 16.0112 0 0 1 -6.17 12.62.9933.9933 0 0 0 -.23 1.35l1.15 1.66a.977.977 0 0 0 1.41.24 19.9576 19.9576 0 0 0 5.91-24.42z"
                fill="#424242" data-original="#424242" class=""></path>
            <path
                d="m54.93 15.93a28.4948 28.4948 0 0 0 -6.24-6.4.9933.9933 0 0 0 -1.41.24l-1.14 1.66a1.0024 1.0024 0 0 0 .24 1.37 23.97 23.97 0 0 1 0 38.4 1.0024 1.0024 0 0 0 -.24 1.37l1.14 1.66a.9933.9933 0 0 0 1.41.24 27.9864 27.9864 0 0 0 6.24-38.54z"
                fill="#424242" data-original="#424242" class=""></path>
        </g>
        <path d="m35 4v56l-5-4.41v-47.18z" fill="#616161"
            data-original="#616161" class=""></path>
        <path
            d="m30 48.21c1.71-1.67 3.38-3.42 5-5.23v17.02l-5-4.41-4.08-3.6c1.38-1.2 2.74-2.47 4.08-3.78z"
            opacity=".2" fill="#000000" data-original="#000000"></path>
        <path
            d="m44 32a11.9212 11.9212 0 0 1 -4.33 9.21.999.999 0 0 1 -1.47-.2l-.64-.93c2.25-2.64 4.4-5.36 6.44-8.08z"
            opacity=".2" fill="#000000" data-original="#000000"></path>
        <path
            d="m52 32a19.9755 19.9755 0 0 1 -7.84 15.87.977.977 0 0 1 -1.41-.24l-1.15-1.66a.9933.9933 0 0 1 .23-1.35 16.0112 16.0112 0 0 0 6.17-12.62 15.7576 15.7576 0 0 0 -.67-4.58q1.425-2.01 2.74-3.97a19.7777 19.7777 0 0 1 1.93 8.55z"
            opacity=".2" fill="#000000" data-original="#000000"></path>
        <path
            d="m60 32a27.9368 27.9368 0 0 1 -11.31 22.47.9933.9933 0 0 1 -1.41-.24l-1.14-1.66a1.0024 1.0024 0 0 1 .24-1.37 23.95 23.95 0 0 0 6.19-31.54c.83-1.28 1.61-2.52 2.36-3.73a27.9 27.9 0 0 1 5.07 16.07z"
            opacity=".2" fill="#000000" data-original="#000000"></path>
    </g>
    </svg>`
;
const mutesvg = 
    ...
    xmlns:xlink="http://www.w3.org/1999/xlink"
    xmlns:svgjs="http://svgjs.com/svgjs" width="512" height="512" x="0" y="0"
    viewBox="0 0 461.55 461.55" style="enable-background:new 0 0 512 512"
    xml:space="preserve" class="">
    <g>
        <g>
            <g id="volume-off">
            ...
            M230.775,25.5l-53.55,53.55l53.55,53.55V25.5z" fill="#000000"
...
const menusvg = 
    `<svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
    xmlns:svgjs="http://svgjs.com/svgjs" width="512" height="512" x="0" y="0"
    viewBox="0 0 276.167 276.167" style="enable-background:new 0 0 512 512" xml:space="preserve"
    class="">
    <g>
        <path
